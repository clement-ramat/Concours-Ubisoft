...
namespace NodeCanvas.Tasks.Actions
{
    ...
    public class FleeFromGhost : ActionTask<NavMeshAgent>
    {
        ...
        protected override void OnExecute()
        {
            ...
            {
                target = ghostEnemy.GhostPlayerGameObject.GetComponent<GhostPlayer>().gameObject;
            }
            else
            {
                //Debug.Log("pas de ghost player");
                EndAction(false);
                return;
            }
